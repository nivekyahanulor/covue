                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-12">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link active" href="<?php echo base_url() . 'consultant/dashboard'; ?>" data-toggle="tooltip" title="Users Referred"><span class="dark-blue-title"><i class="fas fa-users fa-2x"></i></span></a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="card partner-tab">
                            <div class="card-header">
                                <h3 class="card-title"><span class="dark-blue-title">List of Users Referred</span></h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
