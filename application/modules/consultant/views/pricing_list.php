                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-12">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="<?php echo base_url() . 'consultant/pricing-list'; ?>" data-toggle="tooltip" title="IOR Pricing List"><span class="dark-blue-title"><i class="fas fa-search-dollar fa-2x"></i></span></a>
                            </li>
                            <li class="nav-item">
