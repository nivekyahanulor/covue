                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-12">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="<?php echo base_url() . 'consultant/regulated-application'; ?>" data-toggle="tooltip" title="Regulated Application"><span class="dark-blue-title"><i class="fas fa-clipboard-check fa-2x"></i><span></a>
                            </li>
                            <li class="nav-item">
