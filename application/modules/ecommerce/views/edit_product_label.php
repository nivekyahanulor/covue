...
$hscode = $product_registration->hscode;
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="hscode" name="hscode" placeholder="HS Code" value="<?php echo $hscode; ?>" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="product_details" name="product_details" placeholder="Product Name & Details" value="<?php echo $product_details; ?>" readonly>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="expiration_date" name="expiration_date" placeholder="Expiration Date" value="<?php echo date('m/d/Y', strtotime($expiration_date)); ?>" readonly>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 d-flex justify-content-end">
                                                <div class="form-group">
                                                    ...
                                                    <a href="<?php echo base_url(); ?>product_registrations/product_labels" class="btn btn-secondary"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Go Back</a>
                                                </div>
                                            </div>
...
<div class="modal fade" id="modal_product_label_on_process">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure you want to <strong class="text-primary">accept</strong> this Product Label details?
            </div>
            <div class="modal-footer">
