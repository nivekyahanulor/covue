    ...
    <div class="container">
        ...
        <div class="row">
            <div id="IORform" class="col-md-6 offset-md-3">
                ...
                <h4 class="orange-title text-center">Forgot Password</h4>
                ...
                <form action="" method="POST" id="forgot_password" role="form">
                    ...
                    <button type="submit" name="submit" class="btn btn-block btn-outline-orange-alt"><i class="fas fa-lock"></i>&nbsp;&nbsp;Send Password</button>
                </form>
