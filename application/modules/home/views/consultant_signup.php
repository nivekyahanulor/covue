    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div id="IORform" class="col-md-12">
                ...
                <h4 class="orange-title text-center">Create your Consultant Partner account</h4>
                ...
                <form action="" method="POST" id="signup" role="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" id="landing-page-header-title" class="form-control <?php if (form_error('header_title')) {
                                                                                                                echo 'is_invalid';
                                                                                                            } ?>" name="header_title" placeholder="Landing Page Header Title" value="<?php echo set_value('header_title'); ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-12">
                            <div class="form-group">
                                <label for="logo"><strong>Landing Page Content:</strong>
                                    <div id="content_count" class="text-center"></div>
                                </label>
                                <div class="input-group">
                                    <textarea id="landing-page-content" class="form-control <?php if (form_error('content')) {
                                                                                                echo 'is_invalid';
                                                                                            } ?>" maxlength="1000" name="content"><?php echo set_value('content'); ?></textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 offset-md-4 col-12">
                            <div class="form-group">
                                <button type="submit" name="submit" id="btnSignUp" class="btn btn-block orange-btn">Sign Up</button>
                            </div>
                        </div>

                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                <a href="<?php echo base_url(); ?>home/consultant-login" class="btn btn-block btn-outline-dark-blue"><i class="fas fa-arrow-left mr-2"></i>Back</a>
                            </div>
                        </div>
