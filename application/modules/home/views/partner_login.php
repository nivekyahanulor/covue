    ...
    <div class="container">
        ...
        <div class="row">
            <div id="IORform" class="col-md-6 offset-md-3">
                ...
                <h4 class="dark-yellow-title text-center">Partner Company Login</h4>
                ...
                <form action="" method="POST" id="login" role="form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <button type="submit" name="submit" class="btn btn-block btn-dark-yellow"><i class="fas fa-sign-in-alt"></i>&nbsp;&nbsp;Login</button>
                            </div>
                        </div>
						<div class="col-12">
                            <div class="form-group text-center">
                                Don't have an account? <a href="<?php echo base_url(); ?>home/partner-signup" class="dark-blue-link">Sign Up</a>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group text-center">
                                <a href="<?php echo base_url(); ?>home/partners-forgot-password" class="dark-yellow-link">Forgot your password?</a>
                            </div>
                        </div>
                    </div>
