        ...
        <div class="col-12">
          <?php if ($user_details->user_role_id != 3) : ?>
            <ul class="nav nav-tabs">
              <li class="nav-item">
                <a class="nav-link active" href="<?php echo site_url('japan-ior/shipping-invoices'); ?>"><span class="dark-blue-title">Shipping Invoice for Product Selling</span></a>
              </li>
              <li class="nav-item">
                <a class="nav-link dark-blue-link" href="<?php echo site_url('japan-ior/shipping-invoices-product-sampling'); ?>">Shipping Invoice for Product Sampling</a>
              </li>
            </ul>
          <?php endif ?>
                  ...
                  if ($user_details->user_role_id != 3) {
                    if ($user_details->ior_registered == 0 || $user_details->pli == 0) {
                      echo '<span id="IORshippingDisabled" class="d-block" tabindex="0" data-toggle="tooltip" title="Please register your company first to IOR.">
                            <button class="btn btn-block btn-dark-blue" style="pointer-events: none;" type="button" disabled><i class="fa fa-file-invoice mr-2"></i><strong>Shipping Invoice for Product Selling</strong></button>
                          </span>';
                    } else {
                      echo '<a href="#" onclick="showCreateShippingInvoice(\'' . $user_details->user_role_id . '\')" class="btn btn-dark-blue mr-1"><i class="fas fa-file-invoice mr-2"></i><strong>Shipping Invoice for Product Selling</strong></a>';
                    }
                  } else {
                        ...
                        case '1':
                          if ($shipping_invoice->paid == 0) {
                            ...
                            if ($shipping_invoice->billing_invoice_id != 0) {
                              echo '<td align="center"><a href="billing-invoice/' . $shipping_invoice->billing_invoice_id . '"><button type="button"  class="btn btn-sm btn-danger"><i class="fas fa-exclamation-circle mr-2"></i>Pay Now</button></a></td>';
                            } else {
...
<!-- /.content-wrapper -->
<?php if ($this->session->flashdata('success') != null || $this->session->flashdata('congratulation') != null ||$this->session->flashdata('errors') != null ) { } else { ?>
          ...
          <div class="col-12">
            <div class="form-group">
              ...
              <span class="text-danger">
                ...
                <ul>
                  <li>We only accept shipment that are <strong>Incoterms: DDP</strong>.</li>
                  <li>if shipments are not <strong>DDP</strong>, please <a href="https://www.covue.com/contact-us/" class="dark-blue-link" target="_blank"><strong><u>contact us</u></strong></a>.</li>
                </ul>
              </span>
            </div>
          </div>
