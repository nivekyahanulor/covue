                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-12">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="<?php echo base_url() . 'partner-companies/content'; ?>" data-toggle="tooltip" title="Landing Page Customization"><span class="dark-blue-title"><i class="fas fa-sitemap fa-2x"></i></span></a>
                            </li>
                        </ul>
                                ...
                                <table class="table table-bordered table-striped">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center"> <img src="<?php echo base_url() . 'uploads/partners/' . $user_details->landing_page_banner; ?>" width="300px"> </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"> <img src="<?php echo base_url() . 'uploads/partners/' . $user_details->landing_page_background; ?>" width="300px"> </td>
