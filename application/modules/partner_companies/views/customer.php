				...
				<div class="row">
					...
					<div class="col-md-8 col-12">
						...
						<ul class="nav nav-tabs">
							...
							<li class="nav-item">
								<a class="nav-link active" href="<?php echo base_url() . 'partner-companies/customer-users'; ?>" data-toggle="tooltip" title="Shipping Invoices sent"><span class="dark-blue-title"><i class="fas fa-file-invoice-dollar fa-2x"></i></span></a>
							</li>
							<li class="nav-item">
									...
									<tbody>
										...
										if ($count_customer != 0) {
											foreach ($company_customer as $customer_user) {
												...
												echo '  <td align="center" style="vertical-align:middle">' . (($customer_user->invoice_date != '0000-00-00') ? date('m/d/Y', strtotime($customer_user->invoice_date)) : '<a href="#" data-toggle="tooltip" data-placement="top" title="Invoice Date is not yet generated.">N/A</a>') . '</td>';
