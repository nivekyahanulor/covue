      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Shipping Invoices for Product Sampling</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
              ...
              <table id="tblShippingDetails" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  foreach ($shipping_invoices as $shipping_invoice) {
                    ...
                    if (!file_exists($shipping_invoice_pdf_file) && !file_exists($shipping_invoice_final_pdf_file)) {
                      echo ' <td align="center"><a href="#" data-toggle="tooltip" data-placement="top" title="Click Preview button inside first to generate PDF file.">Not Yet Generated</a></td>';
                    }
                      ...
                      switch ($shipping_invoice->shipping_status_id) {
                        case '1':
                          if ($shipping_invoice->paid == '0') {
                            ...
                            echo '<td id="status_' . $shipping_invoice->shipping_invoice_id . '" align="center"><span class="badge badge-primary">Accepted</span></td>';
                          }
                          break;
                        case '2':
                        ...
                        case '4':
                          ...
                          break;
                        case '5':
                          echo '<td id="status_' . $shipping_invoice->shipping_invoice_id . '" align="center"><a href="' . base_url() . 'shipping_invoices/view_revisions_message/' . $shipping_invoice->shipping_invoice_id . '" data-toggle="tooltip" data-placement="top" title="Click to view revisions message"><span class="badge badge-warning">' . $shipping_invoice->label . '</span></a></td>';
                          break;
                        case '6':
