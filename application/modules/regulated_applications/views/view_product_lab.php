            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url() . 'regulated-applications/upload-test-results/' . $reg_product->regulated_application_id; ?>">Lab Results</a></li>
                        ...
                        <div class="row">
                            <div class="col-md-12 d-flex justify-content-end">
                                <div class="form-group">
                                    <a href="<?php echo base_url(); ?>regulated-applications/upload-test-results/<?php echo $reg_product->regulated_application_id ?>" class="btn btn-outline-secondary"><i class="fas fa-arrow-left mr-2"></i>Go Back to Lab Test Results</a>
                                </div>
                            </div>
                        </div>
