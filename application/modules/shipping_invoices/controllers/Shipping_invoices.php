...
class Shipping_invoices extends MX_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('Shipping_invoices_model');
	}
	...
	public function index()
	{
		...
		$data['page_view'] = 'shipping_invoices/shipping_invoices_v';

		$q_all_shipping = $this->Shipping_invoices_model->fetch_shipping_invoices();
	...
	public function accepted()
	{
		...
		$data['external_page'] = 0;
		$data['active_page'] = "shipping_invoices";
		$data['active_url'] = "shipping_invoices/accepted";
		$data['page_view'] = 'shipping_invoices/shipping_invoices_v';

		$q_all_shipping = $this->Shipping_invoices_model->fetch_shipping_custom(1);
		$data['shipping_invoices'] = $q_all_shipping->result();
	...
	public function completed()
	{
		...
		$data['external_page'] = 0;
		$data['active_page'] = "shipping_invoices";
		$data['active_url'] = "shipping_invoices/completed";
		$data['page_view'] = 'shipping_invoices/shipping_invoices_v';

		$q_all_shipping = $this->Shipping_invoices_model->fetch_shipping_custom(2);
		$data['shipping_invoices'] = $q_all_shipping->result();
	...
	public function draft()
	{
		...
		$data['external_page'] = 0;
		$data['active_page'] = "shipping_invoices";
		$data['active_url'] = "shipping_invoices/draft";
		$data['page_view'] = 'shipping_invoices/shipping_invoices_v';

		$q_all_shipping = $this->Shipping_invoices_model->fetch_shipping_custom(3);
		$data['shipping_invoices'] = $q_all_shipping->result();
	...
	public function pending()
	{
		...
		$data['external_page'] = 0;
		$data['active_page'] = "shipping_invoices";
		$data['active_url'] = "shipping_invoices/pending";
		$data['page_view'] = 'shipping_invoices/shipping_invoices_v';

		$q_all_shipping = $this->Shipping_invoices_model->fetch_shipping_custom(4);
		$data['shipping_invoices'] = $q_all_shipping->result();
	...
	public function revisions()
	{
		...
		$data['external_page'] = 0;
		$data['active_page'] = "shipping_invoices";
		$data['active_url'] = "shipping_invoices/revisions";
		$data['page_view'] = 'shipping_invoices/shipping_invoices_v';

		$q_all_shipping = $this->Shipping_invoices_model->fetch_shipping_custom(5);
		$data['shipping_invoices'] = $q_all_shipping->result();
	...
	public function updated()
	{
		...
		$data['external_page'] = 0;
		$data['active_page'] = "shipping_invoices";
		$data['active_url'] = "shipping_invoices/updated";
		$data['page_view'] = 'shipping_invoices/shipping_invoices_v';

		$q_all_shipping = $this->Shipping_invoices_model->fetch_shipping_custom(6);
		$data['shipping_invoices'] = $q_all_shipping->result();
	...
	public function cancel_shipping_invoice()
	{
		...
		$result = $this->Shipping_invoices_model->cancel_shipping_invoice($shipping_invoice_id, $updated_by, $updated_at);
