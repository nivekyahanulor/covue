<?php if ($active_page != 'login' && $active_page != 'registration') : ?>
    ...
    <footer id="footerPartner" class="main-footer" style="background-color: <?php echo $shipping_companies[0]->footer_color; ?>;">
        <center>
            This website is powered by:
            <br><br>
            <img width="300" height="66" src="<?php echo base_url(); ?>assets/img/covue_logo.png" alt="COVUE Japan K.K.">
        </center>
    </footer>
