...
<body class="hold-transition <?php echo ($active_page == 'login') ? 'login-page' : 'sidebar-mini layout-fixed'; ?>">
  ...
  <header id="headerPartner" style="background-color: <?php echo $user_details->header_color; ?>;">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container">
        <div id="navBarPartner" class="navbar-brand">

          <div class="row translated-pages"  style="background-color: <?php echo $user_details->header_color; ?>;"></div>

          <center>
            <a href="<?php echo base_url(); ?>" class="custom-logo-link" rel="home">
              <img src="<?php echo base_url(); ?>/uploads/consultants/<?php echo $user_details->avatar; ?>" class="custom-logo" alt="<?php echo $user_details->contact_person; ?>" height="100px">
            </a>
          </center>
