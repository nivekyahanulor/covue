...
<body class="hold-transition <?php echo ($active_page == 'login') ? 'login-page' : 'sidebar-mini layout-fixed'; ?>">
  ...
  <header id="headerPartner" style="background-color: <?php echo $shipping_companies[0]->header_color; ?>;">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container">
        <div id="navBarPartner" class="navbar-brand">

          <div class="row translated-pages"  style="background-color: <?php echo $shipping_companies[0]->header_color; ?>;"></div>

          <center>
            <a href="<?php echo base_url(); ?>" class="custom-logo-link" rel="home">
              <img src="<?php echo base_url(); ?>/uploads/partners/<?php echo $shipping_companies[0]->logo; ?>" class="custom-logo" alt="<?php echo $shipping_companies[0]->shipping_company_name; ?>" height="100px">
            </a>
          </center>
